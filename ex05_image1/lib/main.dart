...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Ex05_Image1'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          //  해당 배율의 이미지가 있으므로 해당 배율의 분홍 이미지를 사용
          //  기본 폴더에 같은 이름의 이미지는 노란색 이미지
          //  크기를 지정하지 않으면 배율만큼 노란색 크기만큼 자동으로 줄어듬 
          Image.asset(
          'assets/images/300x300b.png',
          ),

          //  해당 배율의 이미지라도 크기를 지정하면 지정한 크기가 적용됨.
          //  Image.asset의 크기가 지정된 것이지 내부의 이미지 크기가 지정된 것이 아님
          Image.asset(
          'assets/images/300x300b.png',
          // fit: BoxFit.fill,
          width: 100, //  액자의 크기를 지정해 주는 것임. 지정해서 사용하는 것이 좋다.
          ),
