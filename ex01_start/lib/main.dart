...
class MyApp extends StatelessWidget { //  상태변화가 없음
...
class MyHomePage extends StatefulWidget { //  상태변화가 있음, 정보가 변함
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //  counter 변수를 1증가시키고 화면을 다시 그리는 메서드
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(  //  머터리얼 디자인 기본 뼈대 위젯
      ...
      floatingActionButton: FloatingActionButton(
        //  클릭시 un)incrementCount() 메서드가 실행한다.
