      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ToggleButtons(
              borderColor: Colors.blueGrey, //  선택 전 테두리 색
              borderWidth: 10,
              selectedBorderColor: Colors.blue, //  선택 후 테두리 색
              splashColor: Colors.cyan, //  선택 후 잠시 보이는 색
              color: Colors.red,  //  선택 전 상태의 색상
              selectedColor: Colors.green,  //  선택 후 버튼 색상
              fillColor: Colors.yellow, //  선택 후 버튼의 배경색
              //  disabledColor
              ...
              onPressed: (int index) {
                setState(() {
                  ...
                  print('isSelected3 : $isSelected3');  //  로그 확인용
                });
              },
